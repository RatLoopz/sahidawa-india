...
export function useVoiceNavigation() {
    ...
    const routeIntent = useCallback(
        (command: string) => {
            ...
            if (
                lowerCmd.includes("pharmacy") ||
                lowerCmd.includes("map") ||
                lowerCmd.includes("aas paas")
            ) {
                router.push("/hi/map");
                ...
                lowerCmd.includes("dawai")
            ) {
                router.push("/hi/scan");
                toast.success("Navigating to Scanner");
            } else if (
                lowerCmd.includes("alert") ||
                lowerCmd.includes("khatra") ||
                lowerCmd.includes("fake")
            ) {
    ...
    useEffect(() => {
        ...
        recognition.onresult = (event: any) => {
            ...
            if (
                ...
                (currentTranscript.includes("suno") || currentTranscript.includes("sahi dawa"))
            ) {
