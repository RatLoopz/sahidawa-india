    ...
    if (status === "permission-denied") {
        return (
            ...
            >
                ...
                <button
                    onClick={handleRetry}
                    className="rounded-full bg-emerald-500 px-6 py-2.5 text-sm font-bold text-white transition-all duration-300 hover:bg-emerald-400 hover:scale-105 active:scale-95 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-black focus:outline-none"
                >
                    Retry
                </button>
            </LiveMessage>
        ...
        <div className="relative h-full w-full">
            ...
            {status === "scanning" && hasTorch && (
                <button
                    onClick={toggleTorch}
                    type="button"
                    className="absolute top-4 right-4 z-40 flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-black/60 text-white backdrop-blur-md transition-all duration-300 hover:bg-black/85 hover:scale-105 active:scale-95"
