...
export default function ScanPage() {
    ...
    return (
        <div className="relative flex h-[calc(100vh-4rem)] flex-col overflow-hidden bg-slate-950 font-sans">
            <input
                type="file"
                id="medicine-upload"
                className="hidden"
            ...
            <div className="absolute inset-0 z-0 bg-slate-950">
                ...
                {/* The Brackets Layer */}
                <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center pb-[30vh] md:justify-start md:pb-0 md:pl-[10vw]">
                ...
                <div className="absolute inset-0 z-20 flex items-center justify-center bg-black/60 p-6 backdrop-blur-sm">
                    ...
                    >
                        ...
                        >
                            ...
                            <p>
                                Firefox or Safari: clear the blocked camera permission and reload.
                            </p>
                        </div>
            ...
            <div className="pointer-events-none absolute inset-x-0 top-0 z-20 w-full bg-gradient-to-b from-slate-950/90 via-slate-950/50 to-transparent pt-2 pb-12">
            ...
            {/* 3. Controls Layer (Floating Bottom/Right Glassmorphism) */}
            <div className="pointer-events-none absolute inset-x-0 bottom-0 z-20 flex flex-col justify-end p-4 pb-6 sm:p-6 md:inset-x-auto md:inset-y-0 md:right-0 md:w-[450px] md:justify-center lg:w-[480px]">
                <div className="scrollbar-hide pointer-events-auto flex max-h-[85vh] w-full flex-col gap-5 overflow-y-auto rounded-[2rem] border border-white/20 bg-white/70 p-6 shadow-2xl backdrop-blur-xl transition-all dark:border-white/10 dark:bg-slate-900/80">
                    {ocrText && (
                        <div className="mx-auto mb-4 w-full max-w-md shrink-0 rounded-2xl border border-emerald-500/30 bg-slate-900/90 p-4 text-xs backdrop-blur-md">
                    ...
                    <div className="mt-4 w-full rounded-2xl border border-(--color-border-muted) bg-(--color-surface-muted) p-6 dark:border-white/10 dark:bg-white/5">
                        ...
                        <div className="flex w-full flex-col gap-3 sm:flex-row">
                            ...
                            <label
                                ...
                                className={`flex flex-1 cursor-pointer items-center justify-center gap-2 rounded-xl border border-(--color-border-muted) bg-white px-4 py-3 text-sm font-bold text-slate-900 shadow-md transition-colors hover:bg-slate-100 focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:outline-none dark:bg-slate-800 dark:text-white dark:hover:bg-slate-700 ${
