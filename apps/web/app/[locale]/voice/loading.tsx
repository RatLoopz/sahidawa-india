export default function VoiceLoading() {
    return (
        <div className="relative flex min-h-screen flex-col overflow-hidden bg-slate-50">
            ...
            <div className="absolute top-0 right-0 -me-20 -mt-20 h-96 w-96 rounded-full bg-emerald-100/40 blur-3xl" />
            <div className="absolute bottom-0 left-0 -ms-20 -mb-20 h-80 w-80 rounded-full bg-blue-100/40 blur-3xl" />
