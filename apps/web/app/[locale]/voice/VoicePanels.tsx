...
export function VoiceReviewPanel({
    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-8 w-full max-w-md rounded-[2.5rem] border border-(--color-border-muted) bg-(--color-surface-page) p-8 shadow-xl duration-500 motion-reduce:animate-none">
            {showEmergency && (
                <div className="mb-6 rounded-2xl border border-red-200 bg-red-50 p-4 text-start dark:border-red-900 dark:bg-red-950/20">
    ...
    return (
        ...
        >
            ...
            <div className="space-y-4">
                {result.emergency && (
                    <div className="rounded-2xl border border-red-200 bg-red-50 p-4 text-start dark:border-red-900 dark:bg-red-950/20">
                        <div className="flex items-start gap-3">
                            <AlertTriangle
                                className="mt-0.5 shrink-0 text-red-600 dark:text-red-400"
                                size={18}
