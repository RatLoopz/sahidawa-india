...
export default function NewSchedulePage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (!selectedMedicine) {
            setError(t("medicineRequiredError"));
            return;
        }
        ...
        try {
            ...
            setError(err instanceof Error ? err.message : t("createScheduleError"));
        } finally {
            setSaving(false);
        }
    };
                ...
                <Card className="border-(--color-border-muted) bg-(--color-surface-page) dark:border-slate-700 dark:bg-slate-900">
                    <form onSubmit={handleSubmit} className="flex flex-col gap-5 p-6">
                        ...
                        <div className="flex items-center gap-3 pt-2">
                            ...
                            >
                                {saving ? t("savingButton") : t("saveScheduleButton")}
                            </button>
                        </div>
                    </form>
                </Card>
