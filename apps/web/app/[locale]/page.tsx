    ...
    return (
        <div className="min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-emerald-200">
            ...
            <main className="container mx-auto max-w-6xl px-4 pt-8 pb-24 md:pb-12">
                ...
                {/* ΓöÇΓöÇ Primary CTA ΓÇö Full-width Scan Button ΓöÇΓöÇ */}
                <button
                ...
                {/* ΓöÇΓöÇ Secondary Action Cards ΓöÇΓöÇ */}
                ...
                {/* ΓöÇΓöÇ AI Health Assistant CTA Banner ΓöÇΓöÇ */}
                ...
                {/* ΓöÇΓöÇ Global Search ΓöÇΓöÇ */}
                <SearchBar />

                {/* ΓöÇΓöÇ Live Alerts Panel (full-width) ΓöÇΓöÇ */}
                <div className="mt-8 mb-20">
                    <div className="bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden flex flex-col">
                        ...
                        <div className="flex-1 overflow-y-auto p-4 bg-slate-50/30">
                            <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                {homepageAlerts && homepageAlerts.length > 0 ? (
                                    ...
                                    /* ΓöÇΓöÇ Improved Empty State ΓöÇΓöÇ */
                        ...
                        {/* ΓöÇΓöÇ View Full Alert Log CTA ΓöÇΓöÇ */}
            ...
            {/* ΓöÇΓöÇ Mobile Bottom Navigation ΓöÇΓöÇ */}
            <nav
