...
export default function SahiDawaHome() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white font-sans text-gray-900 transition-colors duration-300 dark:from-gray-900 dark:to-gray-800 dark:text-gray-100">
            {/* a??a?? Top Navigation a??a?? */}
            <header className="sticky top-0 z-50 w-full border-b border-blue-100 bg-white/80 backdrop-blur-lg dark:border-gray-700 dark:bg-gray-900/80">
                <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-xl font-extrabold tracking-tight text-gray-900 md:text-2xl dark:text-gray-100">
                            SahiDawa
                        </h1>
                    </div>
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 md:gap-4">
                        <nav
                            className="hidden items-center gap-6 text-sm font-semibold text-gray-600 lg:flex dark:text-gray-400"
            ...
            <main className="container mx-auto max-w-6xl px-4 pt-8 pb-24 md:pb-12">
                ...
                <div className="space-y-6 py-12 text-center md:py-20">
                    <div className="animate-in fade-in slide-in-from-bottom-4 inline-flex items-center gap-2 rounded-full border border-blue-200 bg-blue-50 px-4 py-2 text-sm font-bold text-blue-700 duration-700 dark:border-blue-700 dark:bg-blue-900/30 dark:text-blue-400">
                    ...
                    <h2 className="text-4xl leading-[1.1] font-black tracking-tight text-gray-900 md:text-6xl dark:text-gray-100">
                        {tHome("title")}
                    </h2>
                    <p className="mx-auto max-w-2xl text-lg leading-relaxed font-medium text-gray-600 md:text-xl dark:text-gray-400">
                        {tHome("subtitle")}
                    </p>
                ...
                <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    <button
                        onClick={() => handleNavigation("scan")}
                        className="group flex min-h-[170px] w-full flex-col justify-between overflow-hidden rounded-3xl border border-blue-100 bg-white p-6 text-left shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-400 hover:shadow-xl active:scale-[0.99] dark:border-gray-700 dark:bg-gray-800"
                    ...
                    >
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <ChevronRight className="mt-1 h-5 w-5 text-gray-300 transition-all duration-300 group-hover:translate-x-1 group-hover:text-blue-400" />
                        </div>
                        ...
                        <div className="pt-4">
                            ...
                            <p className="mt-1 text-sm leading-snug font-medium text-gray-600 dark:text-gray-400">
                    ...
                    <button
                        ...
                        className="group flex min-h-[170px] w-full flex-col justify-between overflow-hidden rounded-3xl border border-blue-100 bg-white p-6 text-left shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-cyan-400 hover:shadow-xl active:scale-[0.99] dark:border-gray-700 dark:bg-gray-800"
                    ...
                    >
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <ChevronRight className="mt-1 h-5 w-5 text-gray-300 transition-all duration-300 group-hover:translate-x-1 group-hover:text-cyan-400" />
                        </div>
                    ...
                    <button
                        ...
                        className="group flex min-h-[170px] w-full flex-col justify-between overflow-hidden rounded-3xl border border-blue-100 bg-white p-6 text-left shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-amber-400 hover:shadow-xl active:scale-[0.99] dark:border-gray-700 dark:bg-gray-800"
                        aria-label="Pharmacy map"
                    >
                        <div className="flex items-start justify-between gap-4">
                            <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-amber-50 text-amber-600 ring-1 ring-white/60 transition-colors duration-300 ring-inset group-hover:bg-amber-500 group-hover:text-white dark:bg-amber-900/30 dark:text-amber-400 dark:ring-white/10">
                                <MapPin size={28} strokeWidth={2.5} />
                            </div>
                            <ChevronRight className="mt-1 h-5 w-5 text-gray-300 transition-all duration-300 group-hover:translate-x-1 group-hover:text-amber-400" />
                        </div>
                    ...
                    <button
                        ...
                        className="group flex min-h-[170px] w-full flex-col justify-between overflow-hidden rounded-3xl border border-blue-100 bg-white p-6 text-left shadow-sm backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-red-400 hover:shadow-xl active:scale-[0.99] dark:border-gray-700 dark:bg-gray-800"
                    ...
                    >
                        <div className="flex items-start justify-between gap-4">
                            ...
                            <ChevronRight className="mt-1 h-5 w-5 text-gray-300 transition-all duration-300 group-hover:translate-x-1 group-hover:text-red-400" />
                        </div>
                ...
                <div className="group relative mt-8 overflow-hidden rounded-3xl border border-blue-100 bg-white p-6 shadow-md transition-all duration-300 hover:shadow-xl sm:p-8 md:p-10 dark:border-gray-700 dark:bg-gray-800">
                    <div className="pointer-events-none absolute -top-16 -right-16 h-64 w-64 rounded-full bg-cyan-500/10 blur-3xl transition-transform duration-700 group-hover:scale-110" />
                    ...
                    <div className="relative z-10 flex flex-col items-start gap-5 sm:flex-row sm:items-center sm:justify-between sm:gap-6">
                        <div className="flex items-center gap-4">
                            <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-blue-500 to-cyan-500 text-white shadow-lg shadow-blue-500/20">
                        ...
                        <button
                            onClick={() => handleNavigation("health")}
                            className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 px-6 py-3 text-sm font-bold text-white shadow-md transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/30 active:scale-95"
                        >
                            {tHome("try_now")}
                ...
                <section className="mt-12" aria-labelledby="alerts-heading">
                    <div className="mb-6 flex items-center justify-between">
                        ...
                        >
                            <Bell className="mr-2 inline-block h-6 w-6 text-blue-500" />
                            {tHome("recent_alerts")}
                        </h2>
                        <Link
                            href="/alerts"
                    ...
                    {loading ? (
                        ...
                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                            {homepageAlerts.map((alert) => (
                                <div
                                    key={alert.id}
                                    className="flex items-start gap-4 rounded-2xl border border-blue-100 bg-white p-4 shadow-sm transition-all hover:shadow-md dark:border-gray-700 dark:bg-gray-800"
                                >
                ...
                <section className="mt-16 text-center" aria-labelledby="trust-heading">
                    ...
                    <p className="mx-auto mt-2 max-w-xl text-sm font-medium text-gray-600 dark:text-gray-400">
                    ...
                    <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-3">
                        <div className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <h3 className="mt-4 text-lg font-bold text-gray-900 dark:text-gray-100">
                                {tHome("trust_verified")}
                            </h3>
                            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                {tHome("trust_verified_desc")}
                            </p>
                        </div>
                        <div className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                {tHome("trust_global_desc")}
                            </p>
                        </div>
                        <div className="rounded-2xl border border-blue-100 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                            <Activity className="mx-auto h-10 w-10 text-blue-500" />
                            <h3 className="mt-4 text-lg font-bold text-gray-900 dark:text-gray-100">
                                {tHome("trust_real_time")}
                            </h3>
                            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                {tHome("trust_real_time_desc")}
                            </p>
                        </div>
                    </div>
                </section>
                ...
                {/* a??a?? Footer a??a?? */}
                <footer className="mt-16 border-t border-blue-100 pt-8 text-center dark:border-gray-700">
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                        &copy; {new Date().getFullYear()} SahiDawa. {tHome("footer_rights")}
                    </p>
                    <div className="mt-2 flex justify-center gap-4 text-sm text-blue-600 dark:text-blue-400">
