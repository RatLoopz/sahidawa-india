...
function formatRelativeTime(
    ...
    if (!dateString) return tHome("relative_recent");
    ...
    if (elapsed < msPerMinute) {
        return tHome("relative_just_now");
    } else if (elapsed < msPerHour) {
        return tHome("relative_minutes_ago", { count: Math.round(elapsed / msPerMinute) });
    } else if (elapsed < msPerDay) {
        return tHome("relative_hours_ago", { count: Math.round(elapsed / msPerHour) });
    } else {
        return past.toLocaleDateString(locale, { month: "short", day: "numeric" });
    }
}
    ...
    return (
        <div className="min-h-screen bg-(--color-surface-page) font-sans text-(--color-text-primary) transition-colors duration-300">
                ...
                <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
                    ...
                    <div className="flex items-center gap-3 sm:gap-4 md:gap-4">
                        <nav
                            ...
                            aria-label={tHome("main_navigation_label")}
                        >
                                    ...
                                    homepageAlerts.map((alert) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <p className="mt-1 text-sm leading-snug font-medium text-(--color-text-secondary)">
                                                    {alert.composition} {tHome("batch_label")}{" "}
            ...
            <nav
                ...
                aria-label={tHome("mobile_navigation_label")}
            >
                <Link
                    href="/"
