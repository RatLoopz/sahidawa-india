...
// use named imports from recharts below
...
// Workaround: some Recharts component types are incompatible with TSX in this
// environment. Cast them to any to avoid JSX typing errors.
const XAxisAny: any = XAxis;
const YAxisAny: any = YAxis;
const CartesianGridAny: any = CartesianGrid;
const TooltipAny: any = Tooltip;
const AreaAny: any = Area;
const ResponsiveContainerAny: any = ResponsiveContainer;
const AreaChartAny: any = AreaChart;
                        ...
                        <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                            ...
                            <div className="p-6">
                                {topDistricts.length === 0 ? (
                                    ...
                                    <ResponsiveContainerAny width="100%" height={280}>
                                        <BarChartAny data={topDistricts} layout="vertical">
                                            <CartesianGridAny
                                                strokeDasharray="3 3"
                                                stroke="#e2e8f0"
                                            />
