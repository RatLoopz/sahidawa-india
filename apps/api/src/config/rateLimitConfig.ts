...
const defaults: Record<string, EndpointLimit> = {
    verify: { windowMs: 15 * 60 * 1000, maxRequests: 20, label: "Medicine Verification", prefix: "verify" },
    batch: { windowMs: 60 * 60 * 1000, maxRequests: 100, label: "Batch Lookup", prefix: "batch" },
    general: { windowMs: 15 * 60 * 1000, maxRequests: 100, label: "General API", prefix: "general" },
    report: { windowMs: 10 * 60 * 1000, maxRequests: 3, label: "Report Submission", prefix: "report" },
    ...
    compare: { windowMs: 15 * 60 * 1000, maxRequests: 30, label: "Medicine Comparison", prefix: "compare" },
    interactions: { windowMs: 60 * 1000, maxRequests: 10, label: "Interaction Check", prefix: "interactions" },
    interactions_ids: { windowMs: 60 * 1000, maxRequests: 5, label: "Interaction IDs Lookup", prefix: "interactions_ids" },
    eligibility: { windowMs: 15 * 60 * 1000, maxRequests: 20, label: "Eligibility Check", prefix: "eligibility" },
    triage: { windowMs: 60 * 1000, maxRequests: 15, label: "Triage", prefix: "triage" },
    analytics: { windowMs: 15 * 60 * 1000, maxRequests: 10, label: "Analytics", prefix: "analytics" },
    auth: { windowMs: 60 * 1000, maxRequests: 5, label: "Authentication", prefix: "auth" },
    auth_target: { windowMs: 10 * 60 * 1000, maxRequests: 5, label: "Auth Target", prefix: "auth_target" },
    notification_register: { windowMs: 15 * 60 * 1000, maxRequests: 5, label: "Notification Registration", prefix: "notification_register" },
    tracking: { windowMs: 15 * 60 * 1000, maxRequests: 60, label: "Medicine Tracking", prefix: "tracking" },
    webhook: { windowMs: 60 * 1000, maxRequests: 10, label: "Webhook", prefix: "webhook" },
    barcode: { windowMs: 15 * 60 * 1000, maxRequests: 15, label: "Barcode Lookup", prefix: "barcode" },
    schedules: { windowMs: 15 * 60 * 1000, maxRequests: 60, label: "Medicine Schedules", prefix: "schedules" },
    alerts_read: { windowMs: 15 * 60 * 1000, maxRequests: 60, label: "Alerts Read", prefix: "alerts_read" },
    api_keys: { windowMs: 15 * 60 * 1000, maxRequests: 30, label: "API Key Management", prefix: "api_keys" },
